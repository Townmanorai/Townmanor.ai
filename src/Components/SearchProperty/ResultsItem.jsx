...
//                 <h5>
//                   {item.option_4 && item.option_4.includes('Rent') ? (
//                     <>
//                       {item.option_37 && showPrice(item.option_37)}
//                       {item.option_36 && ` ${item.option_36}`}
//                     </>
//                   ) : (
//                     <>
//                       {item.option_36 && ` ${item.option_36}`}
//                       {item.option_37 && ` ${item.option_37}`}
//                     </>
//                   )}
//                 </h5>
//               )}
...
//           </span>
//           <a href="#" title={swInDateFormat(item.date)} className="pull-right">
//             <i className="la la-calendar-check-o"></i>
//             {humanTimeDiff(new Date(item.date))}
//           </a>
//         </div>
//         <a href={item.url} title={item.option_10} className="ext-link"></a>
//       </div>
//     </div>
//   );
// };
...
//   // Implement iframe generation based on multimedia option
...
//   // Implement time difference formatting
//   const now = new Date();
...
//                   {item.option_37 && `${showPrice(item.option_37 )} onwards`}
//                 </h5>
//               )} */}
//                 <h5 className='blackalpenliebe'>
//                   {/* {item.option_37 && `${showPrice(item.option_37 )} onwards`} */}
...
//               )}
//               {item.resitype && (
//                 <span className={`rate-info purpose-${item.resitype.toLowerCase().replace(/ /g, '_')}`}>
//                   {item.resitype}
//                 </span>
//               )}
