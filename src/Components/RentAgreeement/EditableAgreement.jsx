...
const EditableAgreement = ({ agreementData, onSaveContent }) => {
  ...
  const generateAgreementHTML = (data) => {
    ...
    return `
      ...
      <p><strong>3.Property Address:</strong> ${data.property_number}, ${data.floor_number} Floor, ${data.building_name},
      ${data.locality}, ${data.city}, ${data.state}, ${data.pincode}</p>
      
      <p><strong>4. Duration:</strong> ${data.agreement_duration_months} Months commencing from ${formatDate(startDate)} </p>
      ...
      <p><strong> Period of License</strong></p>
      ...
      <p><strong> Electricity Charges</strong></p>
      ...
      <p><strong> Notice for Termination</strong></p>
      ...
      <p><strong> Furniture and Appliances</strong></p>
