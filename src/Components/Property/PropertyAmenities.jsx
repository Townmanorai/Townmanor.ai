...
const PropertyAmenities = ({ amenities }) => {
  // Filter the categoryOptions21 array to only include amenities that match the JSON data
  const filteredAmenities = categoryOptions21.filter(option =>
    amenities.includes(option.option_name)
  );
