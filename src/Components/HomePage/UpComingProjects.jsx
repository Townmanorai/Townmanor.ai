...
// Dummy JSON data for upcoming properties
const upcomingPropertiesData = [
    {
      id: 1,
...
const UpComingProjects = ({ stateName }) => {
  ...
  return (
    <div className="upcoming-projects" id="upcomingProjects">
        ...
        <section className="rented-section has-slider">
          <div className="rented-section-title">
            <div className="rented-title-text strip-blue">
              {stateName ? `Upcoming Projects in ${stateName}` : 'Upcoming Projects in Noida'}
            </div>
          ...
          <div className="rented-property-slider">
            <Slider {...sliderSettings}>
              {upcomingPropertiesData.map((property) => (
