...
const steps = [
  {
    ...
    title: 'Enter Details',
    description: 'Provide project name and RERA registration number'
  },
  {
    icon: (
      <svg
    ...
    title: 'Verify',
    description: 'Our system checks RERA records instantly'
  },
  {
    icon: (
      <svg
          ...
          {steps.map((step, index) => (
            <div key={index} className="townmanor-rera-how-it-works-step">
              ...
              {index < steps.length - 1 && (
                <div className="townmanor-rera-how-it-works-step-arrow">→</div>
              )}
            </div>
          ))}
        </div>
        <div className="townmanor-rera-how-it-works-features">
          {features.map((feature, index) => (
            <div key={index} className="townmanor-rera-how-it-works-feature">
              <div className="townmanor-rera-how-it-works-feature-icon">
                {feature.icon}
              </div>
              <h3>{feature.title}</h3>
