...
function Livspace() {
  ...
  return (
    <>
      ...
      ariaHideApp={false}
      style={{ content: { width: '500px', margin: 'auto' } }} // Custom styles for modal
    >
              ...
              <div className="LeadPopup_form">
                ...
                <div className="mt-4">
                  <p>
                    ...
                    <a href="https://townmanor.in/en/195/terms_and_condition">terms of use</a>, granting us permission to use your personal information as specified in the privacy policy.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="carousel-inner">
          <div className={`carousel-item ${activeIndex2 === 1 ? 'active' : ''}`}>
            ...
            <div className="carousel-caption d-md-block">
              <h5>
              Luxury Interiors, Stress-Free Execution <br />
                <span>Schedule Your Free 3D Design Session!</span>
              </h5>
              <p>Experience unmatched quality & timely delivery with Livspace</p>
          ...
          <div className={`carousel-item ${activeIndex2 === 2 ? 'active' : ''}`}>
            <img
              className="d-block w-100 bg-slider"
              src="https://images.livspace-cdn.com/w:1920/plain/https://d3gq2merok8n5r.cloudfront.net/bumblebee/in/homepage/v2-1675654701-1kKSt/desktop-1675655000-6H0mD/banner-1675655465-eXung/kitchen-homepage-banner-web-1689683306-uyQOf.jpg"
              alt="Second slide"
            />
            <div className="carousel-caption d-md-block">
              <h5>
          ...
          <div className={`carousel-item ${activeIndex2 === 3 ? 'active' : ''}`}>
            <img
              className="d-block w-100 bg-slider"
              src="https://images.livspace-cdn.com/w:1920/plain/https://d3gq2merok8n5r.cloudfront.net/bumblebee/in/homepage/v2-1675654701-1kKSt/desktop-1675655000-6H0mD/banner-1675655465-eXung/dining-room-webbanner-d-1689597794-Kyvb0.jpg"
              alt="Third slide"
            />
            <div className="carousel-caption d-md-block">
              <h5>
      ...
      <div id="interior-tabs-container" style={{background:'#fdfdfd'}}>
        <div class="container">
          ...
          <div class="row justify-content-center align-items-center">
            <div class="col-md-6">
              <div class="ref_contact_content">
                ...
                <button type="button" className="btn-calc" onClick={openModal} style={{marginLeft:'1px'}}>
                  Book 3D Design Session <span>Free</span>
                </button>
              </div>
            </div>
          ...
          <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-3 col-md-6">
              <div class="footer_features_content">
                ...
                <h2>45-day move-in guarantee²</h2>
