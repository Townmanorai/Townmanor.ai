...
function CommercialInterior() {
    ...
    const productData = [
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1725953625.jpg',
            title: 'Spacious Conference Rooms With State-of-the-art Audiovisual Equipment And Sleek, Modern Furniture',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1725953657.jpg',
            title: 'Stylish Glass-enclosed Cabins Set Amidst A Rooftop Garden, With Adjacent Cafeteria',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1725953691.jpg',
            title: 'Stylish Retail Design With Thoughtfully Curated Interior Spaces',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1725953736.jpg',
            title: 'Dynamic Co-working Spaces That Blend Aesthetics And Practicality',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1725953781.jpg',
            title: 'Luxe Corporate Office Interiors That Define Your Brand And Speak To Your Success',
        }
    ];
    ...
    return (
        <>
            ...
            <h2>Commercial Interiors</h2>
                <p></p>
            <p>Commercial interiors focus on creating functional and inviting spaces for businesses and public areas. This includes office spaces for productivity, retail stores for customer experience, restaurants for comfort and style, hotels for luxury and amenities, healthcare facilities for patient comfort and practicality, and educational institutions for effective learning environments. The aim is to blend aesthetics with functionality to support business operations and enhance user experience.</p>
        </div>
