...
function FullHouseinterior() {
    ...
    const productData = [
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1723633762.jpg',
            title: 'Chic Contrast Open-Plan Living Room Design',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1723633901.jpg',
            title: 'White Dining Rooms',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724131415.jpg',
            title: 'Contemporary And Bright Living Room Design',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724132217.jpg',
            title: 'Modern Oasis Living Room Design',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724132298.jpg',
            title: 'Modern TV Unit Design With Integrated Pooja Unit',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724132669.jpg',
            title: 'Rajasthani Elegance Meets Modern Living: A Dream Home In Matunga',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724133626.jpg',
            title: 'Vibrant Elegance: A Fusion Of Color And Contemporary Design In Mumbai Living Room',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724228925.jpg',
            title: 'Chic And Eclectic Full Home Interior With A Touch Of Vibrant Elegance',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724229109.jpg',
            title: 'Vibrant Full Home Interior With An Inviting Pooja Ghar Corner',
        }
    ];
 ...
 />
            ...
            <h2>Full House Interiors</h2>
                <p></p>
            <p>Full house interiors involve designing and decorating every room to create a cohesive and functional living space. This includes stylish and comfortable living rooms, functional dining rooms, efficient kitchens, personalized bedrooms, well-equipped bathrooms, fun and safe kids' rooms, productive home offices, practical hallways and entryways, and organized laundry rooms. The goal is to harmonize aesthetics and functionality to reflect the occupants' style and needs.</p>
        </div>
...
export default FullHouseinterior;
