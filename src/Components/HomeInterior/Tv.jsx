...
function Tv() {
    ...
    const productData = [
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412116.png',
            title: 'Poseidon Modern Entertainment Unit With Display Space',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412250.png',
            title: 'Zeus Compact TV Unit With Storage Drawers',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412296.png',
            title: 'Plutus Contemporary Entertainment Wall Unit',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412397.png',
            title: 'Prometheus Wall-Mounted TV Unit',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412436.png',
            title: 'Heracles Wall-Mounted TV Unit',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412466.png',
            title: 'Oceanus Wall-Mounted TV Unit With Storage',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412499.png',
            title: 'Hades TV Unit For Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412652.png',
            title: 'Cronos TV Unit For Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412701.png',
            title: 'Attis TV Unit With Storage',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412746.png',
            title: 'Rhea Minimal Entertainment Unit With Storage',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412822.png',
            title: 'Flex Entertainment Unit With A Modern Study Corner',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724412873.png',
            title: 'Aphrodite Small Entertainment Unit With Open Shelves',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724413183.png',
            title: 'Artemis Compact Entertainment Unit',
        }
    ];
    ...
    return (
        <>
            ...
            <h2>Tv Unit</h2>
                <p></p>
            <p>A TV unit provides a designated space for placing a television and organizing related electronics and accessories. It typically includes shelves, cabinets, or drawers for storing items like remote controls, gaming consoles, media players, and DVDs. TV units also help manage cables, keeping them tidy and out of sight, and often serve as a focal point in a living room or entertainment area, combining functionality with aesthetic appeal.</p>
        </div>
