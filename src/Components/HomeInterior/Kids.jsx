...
function Kids() {
    ...
    const productData = [
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724235069.jpg',
            title: 'Vibrant And Playful: A Joyful Kids\' Room Designed For Imagination And Movement',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724235288.jpg',
            title: 'Modern Child Bedroom Interior Design In House With Decoration Children',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724235515.jpg',
            title: 'Efficient And Stylish Modern Home Office Design With Storage',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724235763.jpg',
            title: 'Elegant Mid-Century Modern: The Cloud Wide Channel Bed In Rich Walnut Brown',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724236601.jpg',
            title: 'Charming Blush And Grey Kids\' Bedroom: Functional Design With A Touch Of Elegance',
        }
    ];
 ...
 />
            ...
            <h2>Kids Room</h2>
                <p></p>
            <p>A kids' room is a bedroom designed specifically for children, focusing on safety, functionality, and fun. It typically includes a bed, storage for toys and clothes, and study space, such as a desk or table. The decor often features bright colors, playful themes, and age-appropriate furniture that can grow with the child. Safety features like rounded furniture edges, non-slip rugs, and accessible storage are prioritized. A kids' room is a space where children can sleep, play, learn, and express their creativity, often reflecting their interests and personality.</p>
        </div>
