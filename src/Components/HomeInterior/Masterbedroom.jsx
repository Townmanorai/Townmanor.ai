...
function Masterbedroom() {
    ...
    const productData = [
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724220906.jpg',
            title: 'The Grand Millennial Style Bedroom: Sliding Door Wardrobe Design',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724221066.jpg',
            title: 'A Tryst With Browns Master Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724221917.jpg',
            title: 'Cozy And Contemporary Master Bedroom With Warm Tones And Modern Accents',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724221990.jpg',
            title: 'Grey-t Expectations Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724227823.jpg',
            title: 'Vibrant And Stylish Master Bedroom With Bold Accents And Modern Art',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724313775.png',
            title: 'Spectacularly Beige Master Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724313802.png',
            title: 'Simply Contemporary Master Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724313928.png',
    ...
    return (
        <>
            ...
            <h2>Master Bedroom</h2>
                <p></p>
            <p>A master bedroom serves as the primary and often the largest bedroom in a home. It is designed to provide a private, comfortable, and restful space for the main occupants, typically the homeowners. The master bedroom often includes a large bed, nightstands, dressers, and sometimes a seating area.</p>
        </div>
