...
function HomeLane() {
  ...
  return (
    ...
    <div style={{
        ...
        <div class="carousel-inner">
          <div class="carousel-item">
            ...
            <div class="carousel-caption d-md-block">
              ...
              <p>Experience unmatched quality & timely delivery with HomeLane</p>
      ...
      id='interiormodal'// Custom styles for modal
    >
          ...
          <div className={`carousel-item ${activeIndex2 === 1 ? 'active' : ''}`}>
            ...
            <div className="carousel-caption d-md-block">
              <h5 style={{
                ...
                Your <b>only choice</b> for
                <br></br> 
                <b> hassle-free</b> interiors
              </h5>
              <p>Experience unmatched quality & timely delivery with HomeLane</p>
          ...
          <div class="row justify-content-center">
            <div class="col-xl-8">
              <div class="interior-heading-box mb-4">
                <h5>Interior <b>Design Services</b> Under <b>One Roof</b></h5>
            ...
            <div class="col-md-6">
              <div class="interior-CallTo">
                ...
                <div class="CallTo_title">
                  ...
                  <a href="https://townmanor.in/en/196/interior_register" class="RegisTer_NoW_BTN">Register Now <LuLogIn color='grey'/></a>
                </div>
              </div>
            </div>
            <div class="col-md-6">
