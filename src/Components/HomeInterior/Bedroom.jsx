...
function Bedroom() {
    ...
    const productData = [
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1723630661.jpeg',
            title: 'Spacious Minimal Style Convenient Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1723630707.jpeg',
            title: 'Luminous Loft Bedroom Design',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1723630746.jpeg',
            title: 'Officially Fabulous Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1723630803.jpeg',
            title: 'Officially Fabulous Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1723630845.jpeg',
            title: 'Boys Will Be Boys Teenage Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724313543.png',
            title: 'Boisterously Beige Master Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724313631.png',
            title: 'Bright And Bohemian Master Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724313655.png',
            title: 'Minimally Modern Guest Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724313843.png',
            title: 'The Royal Welcome Guest Bedroom',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724313976.png',
            title: 'Color-me-fun Unisex Kids’ Room',
        },
        {
            imageSrc: 'https://townmanor.in/files/customImage/Gallery_1724314438.png',
    ...
    return (
        <>
            ...
            <h2>Bedroom</h2>
                <p></p>
            <p>A bedroom is a personal space designed primarily for rest and relaxation. It typically includes a bed, nightstands, and storage solutions such as dressers or closets. The decor often reflects the occupant's personal style and preferences, with attention to comfort and functionality. Elements like soft lighting, cozy textiles, and calming colors help create a soothing atmosphere conducive to sleep and unwinding. Additional features might include seating areas, desks, or personalized decor items to enhance both comfort and utility.</p>
        </div>
