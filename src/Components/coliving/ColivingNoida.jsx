    ...
    <div className="colivingNoida__container">
      ...
      <div className="colivingNoida__tmluxeInfo">
        ...
        <p className="colivingNoida__tmluxeDesc">
          TM Luxe (Townmanor Studios & Suites) is Townmanor Technology’s upscale extension into the hospitality domain, targeting discerning guests, business travelers, professionals, and couples seeking hotel-like comfort with apartment-style independence. Leveraging Townmanor's proptech heritage, TM Luxe studios & suites are poised to blend the highest service standards with homely amenities. Explore urban living in style.
        </p>
      </div>
