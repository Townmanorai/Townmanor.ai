...
const pricingPlans = [
  {
    ...
    oldPrice: "10000",
    duration: "90 Days",
    benefits: ["90 Days", "Featured in Multiple Listings", "Boost Visibility"],
    claimed: false,
    formAction: "https://secure.payu.in/_payment",
    hiddenInputs: {
      key: "UvTrjC",
...
const AgentsPlans = () => {
  ...
  const handleChoosePlan = (plan) => {
    // Navigate to PaymentForm with the selected plan details
  ...
  return (
    <div className="widget-panel rr5">
      <div className="text-center">
        <h2 className="title">Exclusive Plans for Property Promotion</h2>
        <p>
          Elevate your real estate game with our specialized plans. Whether
          you're looking to feature your listings prominently or boost their
          visibility in search results, we have the perfect option to enhance
          your online presence and attract more potential buyers.
        </p>
      </div>
      <div className="content-box">
        <table className="table table-striped data_table price-pg24 dataTable">
